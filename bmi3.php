...
<div class="container">
    ...
    <?php
function generateRandomError($bmi) {
    $errors = [
        $bmi * rand(2, 5),
        $bmi / rand(2, 5),
        rand(10, 50),
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($weight > 0 && $height > 0) {
        ...
        if (is_numeric($bmi)) {
            ...
            echo "<div class='result' style='color: red; border: 2px solid red; display: block;'>BMI Calculation: $bmi</div>";
        }
    } else {
